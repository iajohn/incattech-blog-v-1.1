<div id="tab-{{ $_3post->slug }}" class="tab-pane fade">
    <div class="row">                           
        @if($_3post->posts()->count() > 0)
            @foreach($_3post->posts()->withCount('favorite_to_users')
	                ...
	                <div class="">
	                    <div class="e-pick-alert">
	                        <div class="alert alert-info text-center">
	                            {{ __("There are no Trending posts in") }} "{{ $_3post->name }}" {{ ("category at the moment check later!") }}
	                        </div>                   
	                    </div>
	                </div>
	            </div>
