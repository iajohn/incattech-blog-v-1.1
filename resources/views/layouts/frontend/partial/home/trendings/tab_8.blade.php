<div id="tab-{{ $_8post->slug }}" class="tab-pane fade">
    <div class="row">                           
        @if($_8post->posts()->count() > 0)
            @foreach($_8post->posts()->withCount('favorite_to_users')
	                ...
	                <div class="">
	                    <div class="e-pick-alert">
	                        <div class="alert alert-info text-center">
	                            {{ __("There are no Trending posts in") }} "{{ $_8post->name }}" {{ ("category at the moment check later!") }}
	                        </div>                   
	                    </div>
	                </div>
	            </div>
