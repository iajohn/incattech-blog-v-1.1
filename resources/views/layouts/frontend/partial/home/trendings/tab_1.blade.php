<div id="tab-{{ $_1post->slug }}" class="tab-pane fade">
    <div class="row">							
    	@if($_1post->posts()->count() > 0)
    		@foreach($_1post->posts()->withCount('favorite_to_users')
                            ...
                            <div class="d-flex justify-content-start a-avt">
                                ...
                                <div class="pt-2">
                                    <a class="" href="{{ route('author.profile',$P1->user->username) }}">
                                        ...
                                        <div class="">
                                            @guest
                                                <a href="javascript:void(0);" onclick="toastr.info('To add heart list. You need to login first.','Info',{
                                                    closeButton: true,
                                                    progressBar: true,
                                                })">
                    ...
                    <div class="">
                        <div class="e-pick-alert">
                            <div class="alert alert-info text-center">
                                {{ __("There are no Trending posts in") }} "{{ $_1post->name }}" {{ ("category at the moment check later!") }}
                            </div>                   
                        </div>
                    </div>
                </div>
