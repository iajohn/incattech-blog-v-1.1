<div id="tab-{{ $_5post->slug }}" class="tab-pane fade">
    <div class="row">                           
        @if($_5post->posts()->count() > 0)
            @foreach($_5post->posts()->withCount('favorite_to_users')
	                ...
	                <div class="">
	                    <div class="e-pick-alert">
	                        <div class="alert alert-info text-center">
	                            {{ __("There are no Trending posts in") }} "{{ $_5post->name }}" {{ ("category at the moment check later!") }}
	                        </div>                   
	                    </div>
	                </div>
	            </div>
