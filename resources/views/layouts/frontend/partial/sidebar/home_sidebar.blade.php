<div class="sidebar col-md-4 col-xs-6 " id="sidebar">
		...
		<div class="row">
            <div class="col-lg-12">
                <div class="section-title">
                    <!-- <h2 class="heading title">{{__('Recomended')}}</h2> -->
                </div>
            </div>
        </div>
					...
					<div class="row">
		                <div class="e-pick-alert col-md-12">
		                    <div class="alert alert-info text-center">
		                        <p>{{ __('Sorry, there are no posts recomemded for you at the moment!') }}</p>
		                    </div>                   
	                	</div>
	                </div>
	        @endif
	...
	<!-- Start Twitter Area -->
	@include('layouts.frontend.partial.sidebar.default_tweet')
	<!-- End Twitter Area -->
