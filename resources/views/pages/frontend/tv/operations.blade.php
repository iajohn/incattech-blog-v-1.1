...
@section('meta')
    @include('meta::manager', [
        ...
        'type'          => 'videos',
        'url'           => URL::asset('tv/{operation}/{value}'),
        {{-- 'image'         => @foreach($videos as $video) asset($video->video_cover_location) @endforeach, --}}
        ...
        'keywords'      => $operationTitle .','.' Incattech, media, fashion, technology, tech, clothing, AR, VR, AI, retail, sustainability',
    ])
@stop
                                                ...
                                                <div class="item large-3 medium-6 columns group-item-grid-default"
                                                    ...
                                                    <div class="post thumb-border">
                                                        <div class="post-thumb">
                                                            ...
                                                            <a href="{{ url('tv', $video->video_slug) }}"
                                                               class="hover-posts">
                                                        ...
                                                        <div class="post-des">
                                                            <h6><a href="{{ url('tv', $video->video_slug) }}">
