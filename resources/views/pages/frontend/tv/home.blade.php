...
@section('meta')
    @include('meta::manager', [
        ...
        'keywords'      => 'Tv, Incattech, media, fashion, technology, tech, clothing, AR, VR, AI, retail, sustainability',
    ])
@stop
                    ...
                    <div class="thumb-slider">
                        <div class="main-image">
                            ...
                            @foreach($featured as $feat)
                                <div class="image {{ $i }}">
                                    <img src="{{ asset($feat->video_cover_location) }}" alt="{{ $feat->video_title }}">
                                    <a href="{{ route('tv.details', $feat->video_slug) }}" class="hover-posts">
                                                ...
                                                style="float: left;">
                                                    <div class="post thumb-border">
                                                        <div class="post-thumb">
                                                            ...
                                                            <a href="{{ route('tv.details', $video->video_slug) }}"
                                                               class="hover-posts">
                                                                <span><i class="fa fa-play"></i>Watch Video</span>
                                                            </a>
                                                        ...
                                                        <div class="post-des">
                                                            <h6><a href="{{ route('tv.details', $video->video_slug) }}">
