...
@section('content')
    <header class="section-header">
        <div class="tbl">
            <div class="tbl-row">
                <div class="tbl-cell">
                    <h3>
                        <i class="font-icon font-icon-plus-1"></i> Add New Playlist
                    </h3>
                </div>
            </div>
        </div>
    ...
    <section class="">
        <div class="container">
            ...
            <form enctype="multipart/form-data" action="{{ route('admin.playlist.store') }}"
                  method="post" class="">
                        ...
                        <div class="card">
                            <div class="body">
                                <fieldset class="form-group">
                                    <label class="form-label" for="video_title">Playlist Name</label>
                                    <input type="text" class="form-control"
                                           id="video_title" name="name" value="{{ old('video_title') }}" placeholder="Enter Playlist Name" />
                                </fieldset>

                                <div class="row">
                                    <div class="col-md-6">
                                        <fieldset class="form-group">
                                            <label class="form-label">Playlist Featured Image Cover (1280x720 px or 16:9 ratio)</label>
                        ...
                        <div class="card">
                            <div class="body">
                                ...
                                <fieldset class="form-control">
                                    <a  class="btn btn-rounded btn-inline btn-danger m-t-15 " href="{{ route('admin.playlist.index') }}">BACK</a>
                            ...
                            <div class="body">
                                ...
                                <fieldset class="form-group">
                                    <div class="panel-body">
                                        <label class="form-label" for="video_desc">Short description of the video Playlist</label>
                                            <textarea rows="3" class="form-control" name="description" id="video_desc"
                                                      placeholder="What Can You Use To Describe This Playlist?">{{ old('video_desc') }}</textarea>
                                    </div>
                                </fieldset>
                            </div>
                        </div>
