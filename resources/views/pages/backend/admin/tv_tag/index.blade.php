...
@section('content')
    <div class="container-fluid">
        <div class="block-header">
            <a class="btn btn-primary waves-effect" href="{{ route('admin.tv-tag.create') }}">
                <i class="material-icons">add</i>
                <span>Add New Tv-Tag</span>
            </a>
        </div>
        <!-- Exportable Table -->
                                        ...
                                        @foreach($tags as $key=>$tag)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="{{ route('admin.tv-tag.edit',$tag->id) }}" class="btn btn-info btn-xs waves-effect">
                                                        <i class="material-icons">edit</i>
                                                    </a>
                                                    <button class="btn btn-danger btn-xs waves-effect" type="button" onclick="deleteTag({{ $tag->id }})">
                                                        <i class="material-icons">delete</i>
                                                    </button>
                                                    <form id="delete-form-{{ $tag->id }}" action="{{ route('admin.tv-tag.destroy',$tag->id) }}" method="POST" style="display: none;">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
                                                </td>
