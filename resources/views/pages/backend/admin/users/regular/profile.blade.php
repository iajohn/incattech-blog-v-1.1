                ...
                <div class="card">
                    <div class="card-header mt-3">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <a href="{{ route('admin.user.profile.edit', ['id' => $user->id ]) }}" class="btn btn-sm btn-primary">{{ __('Edit profile') }}</a>
                                <a href="{{ route('admin.user.index') }}" class="btn btn-sm btn-secondary">{{ __('All users') }}</a>
                            </div>
                        </div>
                    </div>
