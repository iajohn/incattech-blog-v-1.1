                ...
                <div class="card">
                    <div class="header">
                        ...
                        <ul class="header-dropdown m-r--5">
                            <a href="{{ route('admin.user.trashed') }}" title="Trashed Users" class="btn btn-danger waves-effect btn-xs" >
                                            ...
                                            @if($authors->count() > 0)
                                                @foreach($authors as $key=>$author)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ route('admin.user.profile', ['id' => $author->id ]) }}" class="btn btn-info btn-xs waves-effect">
                                                                <i class="material-icons">visibility</i>
                                                            </a>

                                                            <a href="{{ route('admin.user.profile.edit', ['id' => $author->id ]) }}" class="btn btn-primary btn-xs waves-effect">
                                                                <i class="material-icons">edit</i>
                                                            </a>

                                                            @if(Auth::id() !== $author->id)
                                                                <a href="{{ route('admin.user.delete', ['id' => $author->id ]) }}" class="btn btn-danger btn-xs waves-effect">
                                                                    <i class="material-icons">delete</i>
                                                                </a>
                                                            @endif
                                                        </td>
                                                ...
                                                @else
                                                    <tr>
                                                        <th colspan="5" class="alert alert-info text-center">
                                                            There are no record of regular users at the moment!
                                                        </th>                   
                                                    </tr>
                                            @endif
                                        </tbody>
