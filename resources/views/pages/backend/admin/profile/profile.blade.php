                ...
                <div class="card">
                    <div class="card-header mt-3">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4">
                                <a href="{{ route('admin.profile.edit') }}" class="btn btn-sm btn-primary">{{ __('Edit profile') }}</a>
                                <a href="{{ route('admin.author.index') }}" class="btn btn-sm btn-secondary">{{ __('Authors') }}</a>
                                <a href="{{ route('admin.user.index') }}" class="btn btn-sm btn-secondary">{{ __('Regular users') }}</a>
                            </div>
                        </div>
                    </div>
