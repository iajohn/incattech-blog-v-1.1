							...
							<div class="box-body">
								<form method="POST" action="{{ route('register') }}">
									...
									<div class="form-group text-center">
										<span class="text-muted">Already have an account?</span> <a href="{{ route('login') }}" title="{{ __('login') }}">Login</a>
									</div>
								</form>
							</div>
						</div>
...
@push('js')
	<script src="{{ asset('assets/frontend/themes/js/auth/e-magz.js') }}"></script>
@endpush