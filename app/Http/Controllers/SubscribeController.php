...
class SubscribeController extends Controller{
    ...
    public function getAdminSubscriptionForm(){
        $user = User::get(['email']);
        return view('pages.backend.admin.subscription.new')->withTitle('DevTv - User\'s Subscription')->withUsers($user);
    }
    ...
    public function getSubscriptionHistory(Request $request){
        ...
        return view('pages.backend.admin.subscription.index')->withTitle('DevTv -  Subscription History')->withHistorys($history)
            ->with('users', $user);
    }
    ...
    public function showSubscription($tranzid){
        ...
        return view('pages.backend.admin.subscription.show')->withTitle('DevTv -  Subscription Detail\'s')->with('detail', $subscription);
    }
